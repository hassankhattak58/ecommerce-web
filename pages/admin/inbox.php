        ...
        <div class="h-auto justify-center text-center product_list_container" id="products">
            ...
            <table class='text-left border-2 m-auto bg-white w-full'>
                <tr class='bg-green-500'>
                    <th class='py-2 w-10 border-[#000] border-2'>S.no.</th>
                    <th class='py-2 border-[#000] border-2 ' style="width: 250px;"> Title</th>
                    <th class='py-2 border-[#000] border-2' style="width: 250px;">Message</th>
                    <th class='py-2 border-[#000] border-2' style="width: 150px;">Gmail Address</th>
                    <th class='py-2 border-[#000] border-2' style="width: 150px;">Date</th>
                    <th class='py-2 border-[#000] border-2' style="width: 150px;">Action</th>
                </tr>
                <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <td class='py-2 border-[#000] border-2'>$sno</td>
                    <td class='py-2 border-[#000] border-2'>$row[title]</td>
                    <td class='py-2 border-[#000] border-2'>$row[message]</td>
                    <td class='py-2 border-[#000] border-2'>$row[gmailaddress]</td>
                    <td class='py-2 border-[#000] border-2'>$row[datetime]</td>
                    <td class='py-2 flex flex-wrap justify-evenly  h-full'>
                    <button class='p-2 bg-blue-700 text-white m-1 cursor-pointer hover:bg-blue-500 rounded-sm duration-300' onclick='delte_confirm_direct()'>Delete</button>
                    </td>
                    </tr>
                ");
                }
            ...
            <div class="w-[550px] h-[450px] absolute top-[50%] left-[50%] confirm_overlay_popup bg-[#000000ad] z-30" id="parent_confirm_delete">
                <div class="bg-white w-[30rem] h-60 rounded-md   confirm_overlay_popup top-[50%] left-[50%] relative" id="child_confirm_delete">
                    ...
                    <div class="mt-[-38px] pb-2 sm:mt-[-52px]">
                        ...
                        <h3 class="">Click Confirm Delete to Delete the Message or Cancel to Cancel
                            Deletion
                            Process</h3>
                    </div>
                    <a href="delete_msg.php?id=<?php echo $pro_del_id ?>" class="p-2 bg-red-700 text-white m-1 cursor-pointer hover:bg-red-500 rounded-sm duration-300">Confirm
                        Delete</a>
